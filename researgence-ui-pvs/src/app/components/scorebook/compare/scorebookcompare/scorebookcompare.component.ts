...
export class ScorebookcompareComponent implements OnInit {
  ...
  constructor(
    ...
    private excel: ExcelExportService,private authservice:AuthService,private gservice:GeneralApiService
      ...
      this.facService.getUnivLocSchInstDept(this.univId,this.userRole,this.userdetail.UserId,this.locationDropId,this.schoolDropId,this.instituteDropId,this.departmentDropId).subscribe(x=>{
        this.campus=x;
        console.log(x);  
      ...
      generatePDF(): void {
        const universityId = this.univId;
