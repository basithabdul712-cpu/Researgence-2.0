...
export class InsightReportsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.service.getUnivLocSchInstDept(this.univId,this.roleId,'',this.locationFilterId,this.schoolFilterId,this.instituteFilterId,this.deptFilterId).subscribe(x=>{
      this.layerFilter=x;
      console.log(x);  
    ...
    // })
      ...
      this.publicationchart(this.tempfromYear,this.temptoYear,this.locationFilterId,this.schoolFilterId,this.instituteFilterId,this.deptFilterId);
      this.chartIndextrend(this.tempfromYear,this.temptoYear,this.locationFilterId,this.schoolFilterId,this.instituteFilterId,this.deptFilterId);
      this.Dataanalysis(this.tempfromYear,this.temptoYear,this.locationFilterId,this.schoolFilterId,this.instituteFilterId,this.deptFilterId);
      this.jouralcharts(this.tempfromYear,this.temptoYear,this.locationFilterId,this.schoolFilterId,this.instituteFilterId,this.deptFilterId);
      this.countrycollb(this.tempfromYear,this.temptoYear,this.locationFilterId,this.schoolFilterId,this.instituteFilterId,this.deptFilterId);
      this.dbyear(this.tempfromYear,this.temptoYear,this.locationFilterId,this.schoolFilterId,this.instituteFilterId,this.deptFilterId);
      this.stateindia(this.tempfromYear,this.temptoYear,this.locationFilterId,this.schoolFilterId,this.instituteFilterId,this.deptFilterId);

      this.scorebookservice.GetInsightPubTrendByYear(this.univId,this.roleId,this.userDetail.UserId,this.locationFilterId,this.schoolFilterId,this.instituteFilterId,this.deptFilterId,this.fromYear,this.toYear) 
    ...
    publicationchart(tempfromYear, temptoYear, locationid,schoolid,instituteid,departmentid){
      console.log(tempfromYear);
      console.log(temptoYear);
      
      
      this.scorebookservice.GetInsightPubTrendByYear(this.univId,this.roleId,this.userDetail.UserId,locationid,schoolid,instituteid,departmentid,tempfromYear,temptoYear).subscribe((x:any)=>{
...
chartIndextrend(tempfromYear, temptoYear,locationid,schoolid,instituteid,departmentid){
  this.scorebookservice.GetInsightPubIndexedTrendByYear( this.univId,this.roleId,this.userDetail.UserId,locationid,schoolid,instituteid,departmentid,tempfromYear,temptoYear).subscribe((r:any)=>{
...
Dataanalysis(tempfromYear, temptoYear,locationid,schoolid,instituteid,departmentid){
  this.scorebookservice.GetInsightPubDBCountByYear(this.univId,this.roleId,this.userDetail.UserId,locationid,schoolid,instituteid,departmentid,tempfromYear,temptoYear).subscribe((responses:any) => {
...
jouralcharts(tempfromYear, temptoYear, locationid,schoolid,instituteid,departmentid){
  this.scorebookservice.GetInsightJournalPubCount(this.univId,this.roleId,this.userDetail.UserId,locationid,schoolid,instituteid,departmentid,tempfromYear,temptoYear).subscribe((x:any)=>
  {
...
countrycollb(tempfromYear, temptoYear, locationid,schoolid,instituteid,departmentid){
  this.scorebookservice.GetInsightCountryCollaboration(this.univId,this.roleId,this.userDetail.UserId,locationid,schoolid,instituteid,departmentid,tempfromYear,temptoYear).subscribe((datas:any)=>{
...
dbyear(tempfromYear, temptoYear, locationid,schoolid,instituteid,departmentid){
  this.scorebookservice.GetInsightCitationByYearDB(this.univId,this.roleId,this.userDetail.UserId,locationid,schoolid,instituteid,departmentid,tempfromYear,temptoYear).subscribe((cit:any)=>
  {
this.citation=cit;
...
stateindia(tempfromYear, temptoYear,locationid,schoolid,instituteid,departmentid){
  this.scorebookservice.GetInsightStateCollaboration(this.univId,this.roleId,this.userDetail.UserId,locationid,schoolid,instituteid,departmentid,tempfromYear,temptoYear).subscribe(sta=>
    {
  this.state=sta;
...
bullet3.fill = am4core.color("#dc3545"); // Red color for IEEE
...
//   let root = am5.Root.new("chartddiv");
...
// createSeries("GS", "gs");
// createSeries("IEEE", "ieee");
// createSeries("PUBMED", "pub");
...
filter1() { 
  ...
  if (this.tempfromYear !== undefined || this.temptoYear !== undefined) {
    ...
    this.publicationchart(fromDate, toDate,this.locationFilterId,this.schoolFilterId,this.instituteFilterId,this.deptFilterId);
    this.chartIndextrend(fromDate, toDate,this.locationFilterId,this.schoolFilterId,this.instituteFilterId,this.deptFilterId);
    this.Dataanalysis(fromDate, toDate,this.locationFilterId,this.schoolFilterId,this.instituteFilterId,this.deptFilterId);
    this.jouralcharts(fromDate, toDate,this.locationFilterId,this.schoolFilterId,this.instituteFilterId,this.deptFilterId);
    this.countrycollb(fromDate, toDate,this.locationFilterId,this.schoolFilterId,this.instituteFilterId,this.deptFilterId);
    this.dbyear(fromDate, toDate,this.locationFilterId,this.schoolFilterId,this.instituteFilterId,this.deptFilterId);
    this.stateindia(fromDate, toDate,this.locationFilterId,this.schoolFilterId,this.instituteFilterId,this.deptFilterId);
  }
