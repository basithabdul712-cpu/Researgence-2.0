...
@Component({
  selector: 'app-pantent-dashboard-level',
  templateUrl: './pantent-dashboard-level.component.html',
  styleUrls: ['./pantent-dashboard-level.component.scss','./../../../../assets/given/newcss/style.css']
})
export class PantentDashboardLevel implements OnInit {
