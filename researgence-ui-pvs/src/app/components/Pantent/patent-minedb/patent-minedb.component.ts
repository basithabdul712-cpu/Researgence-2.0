...
export class PatentMinedbComponent implements OnInit {
  ...
  ngOnInit() {
    this.insight='/scorebook/Publications/InsightReports';
      ...
      this.facultyservice.getUnivLocSchInstDept(this.univId,this.roleId,this.user.UserId,this.locationFilterId,this.schoolFilterId,this.instituteFilterId,this.deptFilterId).subscribe(x =>{
        this.campus =x;
        console.log(x);
