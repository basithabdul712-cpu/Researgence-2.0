	...
	MENUITEMS: Menu[] = [
		...
		},
		{
			title: 'R+ Subscriptions', icon: 'check-square', type: 'sub', active: false, children: [
				...
				{
					path: '/performance-analysis-dashboard',title: "Performance Analysis",type: "link",icon: "airplay",onClick: "openCard"
				},
				{
		...
		},
		{
			title: 'Support', icon: 'settings', type: 'sub', active: false, children: [
				{
					title: 'My Addition', icon: 'settings', type: 'sub', active: false, children: [
						{
							path: '/facultyProfiles/Support/MyAdditions',title: "Publications",type: "link",icon: "airplay",onClick: "openCard"
						},
						{
							path: '/facultyProfiles/Support/Mypatent',title: "Patents",type: "link",icon: "airplay",onClick: "openCard"
						},
						{
							path: '/Project/added/list',title: "Projects",type: "link",icon: "airplay",onClick: "openCard"
						}
				]  
		     },
				// {
		...
		{
			path: '/clientadmin/universitySelect/RFS/view/univ', title: 'RFS Publication', icon: 'slack', type: 'link' 
		},
		{
		...
		{
			path: '/scorebook/Publications/Mine',title: 'Resolve Publication',icon:'slack',type:'link'
		}
	]
