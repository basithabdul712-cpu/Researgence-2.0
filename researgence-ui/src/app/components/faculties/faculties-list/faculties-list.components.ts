    ...
    ngOnInit() {  
      ...
      //For rolename getting
          // this.authservice.RoleSelection(this.userDetail.UniversityId,this.userDetail.UserId).subscribe(x=>{
            ...
            const dataRole=this.role.filter(item=> item.roleId==this.tempRole);
           ...
           this.service.getUnivLocSchInstDept(this.userDetail.UniversityId,this.userRole,this.userDetail.UserId,this.locationFilterId,this.schoolFilterId,this.instituteFilterId,this.deptFilterId).subscribe(x=>{
            ...
            // this.service.getUnivCheckModule(this.userDetail.UniversityId).subscribe(t=>{  
              ...
              let pubList=this.moduleList.filter(x=>x.moduleName=="Publications"||x.moduleName=="Patents"||x.moduleName=="Edited Publications"||x.moduleName=="Design Patent"||x.moduleName=="Copyrights"||x.moduleName=="Trademarks"||x.moduleName=="Projects");
                 for(let i=0;i<pubList.length;i++){
                   ...
                   else if(pubList[i].moduleName=="Edited Publications"){
                          this.enableEditPub=pubList[i].isApplicable;
                   }
                   else if(pubList[i].moduleName=="Design Patent"){
                        this.enableDP=pubList[i].isApplicable;
                   }
                   else if(pubList[i].moduleName=="Copyrights"){
                    this.enableCR=pubList[i].isApplicable;
                  }
                  else if(pubList[i].moduleName=="Trademarks"){
                    this.enableTM=pubList[i].isApplicable;
                  }
                  else if(pubList[i].moduleName=="Projects"){
                    this.enableProject=pubList[i].isApplicable;
                  }
                 }
                }
            // });
                    ...
                    for (let i = 0; i < this.filteredItems.length; i++) {
                      ...
                      if (Array.isArray(this.filteredItems) && this.filteredItems[i].hasOwnProperty('userProfilePicLocation')) {
                          ...
                          if (this.imageToShow.find(x => x == this.filteredItems[i].empId)) {
                              ...
                              if(userProfilePicLocation!=null){
