...
@Component({
  selector: 'app-dfs-publication-edit',
  templateUrl: './dfs-publication-edit.component.html',
  styleUrls: ['./dfs-publication-edit.component.scss', './../../../../assets/given/newcss/dfs-style/style.css','./../../../../assets/given/newcss/dfs-style/bootstrap.min.css',]
})
export class DfsPublicationEditComponent implements OnInit {
    ...
    if(this.enableHome==true||this.enableAway==true){
      ...
      if(this.feeders[0].universityName==""||this.feeders[0].universityName==null){
        ...
        for (let i = 0; i < this.tempusers.length; i++) {
          ...
          this.tempusers[i].publicationUserSeqNoUI=this.tempusers[i].tempId+1;
        ...
        if(this.typeName=="DFS"){
          this.facService.savePublicationNew(data, this.user.UserId, this.roleId).subscribe(x => {
            ...
            this.facService.savePubNewRFS(data, this.user.UserId, this.roleId,0).subscribe(x => {
              const confirmation = confirm('Update Details Successfully');
              if (confirmation) {
                if(this.roleId=="12"){  
