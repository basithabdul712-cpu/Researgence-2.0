    ...
    constructor(private menuService: MenuService, private service: FacultiesService,private http: HttpClient,
      private datePipe: DatePipe,private route: ActivatedRoute,private router:Router,private authService:AuthService) {     
        ...
        ngOnInit() {
          ...
          this.route.params.subscribe(params => {
            ...
            if(this.layerType=="3LType1"||this.layerType=="4LType1"||this.layerType=="3LType2"){
               ...
               this.locationname=params.name;
                ...
                if(this.deptid==0){
                   this.deptGroupId=localStorage.getItem("DeptgroupId");
                 }
                 else{
         ...
         this.service.getProfileDashboardCount(this.userDetail.UniversityId,this.roleId,this.userDetail.UserId,this.levelId,this.locationid,this.schoolid,this.instituteid,this.deptid,this.deptGroupId).subscribe(x=>{
          console.log(x);
          this.profCount=x;
          ...
          this.service.getProfileDbCount(this.userDetail.UniversityId,this.roleId,this.userDetail.UserId,this.levelId,this.locationid,this.schoolid,this.instituteid,this.deptid,this.deptGroupId).subscribe(t=>{
            this.pubDbCount=t; 
            this.filteredItems=this.pubDbCount;
            console.log(this.filteredItems);
            
           this.service.getProfileCollabCount(this.userDetail.UniversityId,this.roleId,this.userDetail.UserId,this.levelId,this.locationid,this.schoolid,this.instituteid,this.deptid,this.deptGroupId).subscribe((x:any)=>{
