...
export class FacultyCompareComponent implements OnInit {
  ...
  ngOnInit() {  
    ...
    this.Name = this.user['http://schemas.xmlsoap.org/ws/2005/05/identity/claims/name'];
      ...
      if(this.userRole==12){
        var tempUnivId=localStorage.getItem("NewUnivId");
        this.service.getUnivLocSchInstDept(tempUnivId,this.userRole,this.user.UserId,this.locationFilterId,this.schoolFilterId,this.instituteFilterId,this.deptFilterId).subscribe(x=>{
          this.layerFilter=x;
          console.log(x);  
    ...
    sort(columnName: string) {
      ...
      this.facultiesListdata.sort((a, b) => {
        ...
        exportExcel() {
          ...
          str = str.replace(/\"authorName\":/g, '"Name of Faculty":');
    ...
    onOpenCalendar(container) {
      ...
      container.setViewMode('month');
            ...
            this.facultyCompareData.filter = 0;
             ...
             //  To enable page load icon
               ...
               this.enableFilterText=true;
                  ...
                  this.service.ResearcherCompare(this.facultyCompareData).subscribe(data => {
                    this.facultiespub = data;
                  this.facultiesListdata = this.facultiespub.dataList;
                  // To disable pageload icon
                  this.enablePic=false;
                  console.log(this.facultiesListdata);
        ...
        downloadCsv(): void {
          this.agGridComponent.exportToExcel('FACULTY COMPARE');
        }  
