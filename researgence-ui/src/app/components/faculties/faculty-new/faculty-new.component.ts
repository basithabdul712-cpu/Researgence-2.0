            ...
            if(this.titleId!=null||this.titleId!=undefined){
              ...
              if(this.dateOfBirth==null){
                ...
                if(this.dateOfJoining==null){
                  ...
                  if(this.layer=='3LType1'||this.layer=='3LType2'||this.layer=='4LType1'){
                    if(this.locationFilterId==0){
                      return;
                    }    
                  }
                  if(this.layer=='4LType1'||this.layer=='4LType2'||this.layer=='3LType3'){
                    if(this.schoolFilterId==0){
                      return;
                    }
                    
                  }
                  if(this.layer=='2LType1'||this.layer=='3LType1'||this.layer=='3LType3'||this.layer=='4LType1'||this.layer=='4LType2'){
                    if(this.instituteFilterId==0){
                      return;
                    }       
                  }
                  if(this.layer=='2LType1'||this.layer=='3LType1'||this.layer=='3LType2'||this.layer=='3LType3'||this.layer=='2LType2'||this.layer=='4LType1'||this.layer=='4LType2'){
      ...
      filters(val){
        ...
        if(val=="loc"){
          ...
          this.service.getUnivLocSchInstDept(this.universityId,this.roleId,this.user.UserId,this.locationFilterId,this.schoolFilterId,this.instituteFilterId,this.deptFilterId).subscribe(x=>{
            ...
            else if(this.layer=="4LType2"||this.layer=="3LType3"||this.layer=="4LType1"){
            this.layerSchool=x;
          ...
          if(val=="scl"){
            if(this.schoolName!=undefined){
               if(this.layer=="4LType2"||this.layer=="3LType3"){
                ...
                const schoolfilter=this.layerInsSchCamDep.filter(item=> item.schoolName==this.schoolName&&item.locationName==this.locationName);
                this.schoolFilterId=schoolfilter[0].schoolId;
              }
            }
           else{
          ...
          if(val=="inst"){
                ...
                if(this.instituteName!=undefined){
                  ...
                  if(this.layer=="3LType1"){
                    const instfilter=this.layerInsSchCamDep.filter(item=>item.instituteName==this.instituteName&&item.locationName==this.locationName)
                    this.instituteFilterId=instfilter[0].instituteId;
                  }
                  else if(this.layer=="4LType2"||this.layer=="3LType3"||this.layer=="4LType1"){
                    const instfilter=this.layerInsSchCamDep.filter(item=>item.instituteName==this.instituteName&&item.schoolName==this.schoolName)
                    this.instituteFilterId=instfilter[0].instituteId;
                  }
                  else{
