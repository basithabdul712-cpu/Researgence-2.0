...
@Component({
  selector: 'app-project-dashboard-level',
  templateUrl: './project-dashboard-level.component.html',
  styleUrls: ['./project-dashboard-level.component.scss','./../../../../assets/given/newcss/style.css']
})
export class ProjectDashboardLevel implements OnInit {
  ...
  pubDbCount3:any;
  totalCount3:any;
  filteredItems3:{layerTypeName:string;layerTypeDesc:string;layerLevel: string;universityId:string;locationId: string;schoolId:string;instituteId:string;departmentId:string;projectFundingAgencyName:string;stageLevelCount:string;totCount: string}[]=[];
  ...
  totalCount4:any;
  pubDbCount4:any;
  filteredItems4:{layerTypeName:string;layerTypeDesc:string;layerLevel: string;universityId:string;locationId: string;schoolId:string;instituteId:string;departmentId:string;projectFundingAgencyName:string;stageLevelCount:string;totCount: string}[]=[];
  ...
  numbers5: number[] = [];
  pubDbCount5:any;
  filteredItems5:{layerTypeName:string;layerTypeDesc:string;layerLevel: string;universityId:string;locationId: string;schoolId:string;instituteId:string;departmentId:string;projectFundingAgencyName:string;stageLevelCount:string;totCount: string}[]=[];
  ...
  ngOnInit(){
    ...
    this.route.params.subscribe(params => {
      ...
      if(this.layerType=="3LType1"||this.layerType=="4LType1"||this.layerType=="3LType2"){
        ...
        if(this.deptid==0){
          this.deptGroupId=localStorage.getItem("ProjDeptgroupId");
        }
        else{
      ...
      this.service.getProjectDashboardByLayer(this.userDetail.UniversityId,this.roleId,this.userDetail.UserId,this.levelId,this.locationid,this.schoolid,this.instituteid,this.deptid,this.deptGroupId).subscribe(x=>{
        console.log(x);
        this.profCount=x;
        ...
        if(this.profCount.length>0){
          ...
          this.service.getProjectDashboardByFundingAgency(this.userDetail.UniversityId,this.roleId,this.userDetail.UserId,this.levelId,this.locationid,this.schoolid,this.instituteid,this.deptid,this.deptGroupId).subscribe(y=>{
            this.pubDbCount=y;
