...
@Component({
  selector: 'app-project-edit-by-mine',
  templateUrl: './project-edit-by-mine.component.html',
  styleUrls: ['./project-edit-by-mine.component.scss','./../../../../assets/given/newcss/style.css']
})
export class ProjectEditByMineComponent implements OnInit {
  ...
  constructor( private router:Router,private authservice:AuthService,private service:AdminclientService,private gservice:GeneralApiService,
    private menuService:MenuService,private facultyservice: FacultiesService,private fb: FormBuilder) {
     }
    
     ngOnInit() {
      //for accessing menuopen 
      localStorage.removeItem("editProjectMineSearch");
          ...
          if(this.univId==undefined){
              ...
              this.pubSearchList=[];
                  if(this.pubTitle==""){
                    ...
                    console.log(data);
                    localStorage.setItem("editProjectMineSearch", JSON.stringify(data));
                     this.router.navigate(['/Project/edit/mine/search/detail'])
                  }              
              }
