...
@Component({
    selector: '',
    templateUrl: 'student-list.components.html',
...
export class StudentListComponent implements OnInit {
    ...
    data: Studentlist = new Studentlist();
    public cisupport = [11];
    public hod =[9];
    public hoi =[8];
    public hoc =[7];
    ...
    ngOnInit() {  
        ...
        this.uibaseurl='/Student'; 
        this.compareurl='/Student/compare/sch';
      ...
      //For rolename getting
          ...
          onWindowScroll() {
              ...
              fetchData() {
                ...
                this.service.getStudentList(this.data)
            ...
            if(val=="dept"){
              ...
              if(this.filterDepart==""&&this.filterInst==""&&this.filterCamp==""&&this.filterSchool==""){
                ...
                if(this.userRole==17){
                  ...
                  this.service.getStudentList(this.data).subscribe((x:HttpResponse<any>) => {
                    console.log('Response:', x);
                    if (x.status === 200) {
                      this.dynamicpage = x.body;   
                    } else {
