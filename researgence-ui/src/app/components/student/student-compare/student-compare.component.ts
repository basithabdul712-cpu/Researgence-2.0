...
import {StudentCompareData} from './studentcomparedata';


@Component({
  selector: 'app-student-compare',
  templateUrl: './student-compare.component.html',
  styleUrls: ['./../../../../assets/given/newcss/style.css', './../../../../assets/given/selected.css']
})
export class StudentCompareComponent implements OnInit {
    ...
    facultiespubs: any;
    roleId: any;
    scholarCompareData: StudentCompareData = new StudentCompareData();
    num: number=0;
    filtercondition: any;
    fromMonthYear: any;
    toMonthYear: any;
  ...
  ngOnInit() {  
    ...
    getCompareExcelData() {
      ...
      this.service.ResearcherStudentCompare(this.scholarCompareData)
        .subscribe(x => {
          this.excelList = x;
      ...
      getFacultyCompareDetails() {
        ...
        this.service.ResearcherStudentCompare(this.scholarCompareData).subscribe(
          data => {
            console.log(data)
