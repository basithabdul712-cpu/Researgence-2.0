...
import {ScholarCompareData} from './scholarcomparedata';


@Component({
  selector: 'app-scholar-compare',
  templateUrl: './scholar-compare.component.html',
  styleUrls: ['./scholar-compare.component.scss','./../../../../assets/given/newcss/style.css', './../../../../assets/given/selected.css']
})
export class ScholarCompareComponent implements OnInit {
    ...
    facultiespubs: any;
    roleId: any;
    scholarCompareData: ScholarCompareData = new ScholarCompareData();
    num: number=0;
    filtercondition: any;
    fromMonthYear: any;
    toMonthYear: any;
  ...
  ngOnInit() {  
    ...
    getCompareExcelData() {
      ...
      this.service.ResearcherScholarCompare(this.scholarCompareData)
        .subscribe(x => {
          this.excelList = x;
      ...
      getFacultyCompareDetails() {
        ...
        this.service.ResearcherScholarCompare(this.scholarCompareData).subscribe(
          data => {
            console.log(data)
