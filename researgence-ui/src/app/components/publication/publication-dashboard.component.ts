  ...
  numbers: number[] = [];
    ...
    private http: HttpClient,private datePipe: DatePipe,private elementRef: ElementRef,
      private router:Router,private authService:AuthService) { 
        ...
        ngOnInit() {
          localStorage.removeItem("DeptgroupId");
        ...
        // })
         ...
         this.service.getProfileDashboardCount(this.userDetail.UniversityId,this.roleId,this.userDetail.UserId,this.levelId,this.locationid,this.schoolid,this.instituteid,this.deptid,null).subscribe(x=>{
          console.log(x);
          this.profCount=x;
          ...
          this.initializeCounter();
           ...
           this.service.getProfileDbCount(this.userDetail.UniversityId,this.roleId,this.userDetail.UserId,this.levelId,this.locationid,this.schoolid,this.instituteid,this.deptid,null).subscribe(t=>{
            this.pubDbCount=t;
            this.filteredItems=this.pubDbCount;
            console.log(this.filteredItems);
            console.log(this.pubDbCount);
            
           this.service.getProfileCollabCount(this.userDetail.UniversityId,this.roleId,this.userDetail.UserId,this.levelId,this.locationid,this.schoolid,this.instituteid,this.deptid,null).subscribe((x:any)=>{
            console.log(x);
        ...
        viewLevel(val,levelval,layer,name,groupId){
              ...
              if(layer=="2LType2"){
                 localStorage.setItem("DeptgroupId",groupId)
              }
