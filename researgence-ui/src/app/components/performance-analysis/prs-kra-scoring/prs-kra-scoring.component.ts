...
@Component({
  selector: 'app-prs-kra-scoring',
  templateUrl: './prs-kra-scoring.component.html',
  styleUrls: ['./prs-kra-scoring.component.scss','./../../../../assets/given/newcss/style.css', './../../../../assets/given/selected.css']
})
export class PRSKRAScoringComponent implements OnInit {
  ...
  ngOnInit() {  
      ...
      getFacultyCompareDetails() {
          ...
          // this.facultiesListdata=this.facultiespub;
             this.service.GetPRSKRAScoring(this.user.UniversityId,this.userRole,this.user.UserId,this.locationFilterId,this.schoolFilterId,this.instituteFilterId,this.deptFilterId,this.deptGrpId).subscribe(data=>{
        ...
        downloadCsv(): void {
          this.agGridComponent.exportToExcel('PRS - KRA Scoring');
        }  
