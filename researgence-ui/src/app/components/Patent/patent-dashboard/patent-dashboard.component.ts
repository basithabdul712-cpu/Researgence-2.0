...
@Component({
  ...
  styleUrls: ['./patent-dashboard.component.scss','./../../../../assets/given/newcss/style.css']
})
export class PatentDashboard implements OnInit {
  ...
  ngOnInit(){
    ...
    localStorage.removeItem("PatentDeptgroupId");
    ...
    // })
      this.service.getPatentLayer(this.userDetail.UniversityId,this.roleId,this.userDetail.UserId,this.levelId,this.locationid,this.schoolid,this.instituteid,this.deptid,null).subscribe(x=>{
        console.log(x);
        this.profCount=x;
        ...
        this.service.getPatentStage(this.userDetail.UniversityId,this.roleId,this.userDetail.UserId,this.levelId,this.locationid,this.schoolid,this.instituteid,this.deptid,null).subscribe(y=>{
          this.pubDbCount=y;
  ...
  viewLevel(val,levelval,layer,name,groupId){
    ...
    if(layer=="2LType2"){
      localStorage.setItem("PatentDeptgroupId",groupId)
   }
