...
@Component({
  selector: 'app-patent-qc-approval',
  templateUrl: './patent-qc-approval.component.html',
  styleUrls: ['./patent-qc-approval.component.scss','./../../../../assets/given/newcss/style.css']
})
export class PatentQcApprovalComponent implements OnInit {
  ...
  ngOnInit() {
      ...
      edit(patId,inputSource,univ){  
           this.router.navigate(['/Patent/Edit/'+patId+'/'+inputSource+'/'+univ]);
      }

  getList() {
    this.service.getpatentApprovalList(this.userName, this.user.UserId,this.universityparamId).subscribe(x => {
  ...
  getCheckedItemList() {
    ...
    console.log(this.checkedList); 
          ...
          approveSelectedItems() {
                  ...
                  this.Approve=1;
                    ...
                    if (selectedCount > 0) {
                      ...
                      this.service.patentQcApproval(postdata,this.user.UserId,this.roleid,this.Approve).subscribe(x=>{                   
      ...
      onRejectButtonClick() {
            ...
            if (selectedCount > 0) {
              ...
              this.service.patentQcApproval(postdata,this.user.UserId,this.roleid,this.reject).subscribe(x=>{                   
    ...
    exportexcel() {
      this.service.getpatentApprovalList(this.userName, this.user.UserId, this.universityparamId)
        .subscribe((data: any) => {
          this.dataList = data;
          console.log(data);
    ...
    processAndExportToExcel() {
      ...
      const modifiedDataList = this.dataList.map(({
        srcUniversityName,patentTitle, applicationNumber, patentStatus,inventors,applicants, inputSource, createdByName,
      ...
      this.excel.exportAsExcelFile(modifiedDataList, "Patent-QC-Approval List");
    }
