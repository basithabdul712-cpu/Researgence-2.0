...
@Component({
    selector: '',
    templateUrl: 'staff-list.components.html',
...
export class StaffListComponent implements OnInit {
    ...
    ngOnInit() {  
        ...
        this.uibaseurl='/Staff'; 
        this.compareurl='/Staff/compare/sch';
      ...
      //For rolename getting
          ...
          onWindowScroll() {
              ...
              fetchData() {
                ...
                this.service.getStaffList(this.data)
