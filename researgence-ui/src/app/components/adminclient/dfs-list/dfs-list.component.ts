...
@Component({
  selector: 'app-dfs-list',
  templateUrl: './dfs-list.component.html',
  styleUrls: ['./dfs-list.component.scss','./../../../../assets/given/newcss/style.css']
})
export class DfsListComponent implements OnInit {
  ...
  ngOnInit() {
      ...
      edit(publicationid,inputSource,univ){
        ...
        this.router.navigate(['/clientadmin/dfs-editor/editor/'+publicationid+'/'+inputSource+'/'+univ]);
